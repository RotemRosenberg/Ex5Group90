...
public class DBservices
{
    ...
    //quick Edit course
    public bool QuickEditCourse(int id,string title,bool isActive)
    {
        ...
        cmd = CreateCommandWithStoredProcedure("SP_QuickEditCourse", con, paramDic);             // create the command
    ...
    public List<Course> ReadCourse()
    {
        ...
        try
        {
            ...
            while (dataReader.Read())
            {
                ...
                course.IsActive = Convert.ToBoolean(dataReader["IsActive"]);
    ...
    public Object Top5Courses()
    {
        ...
        cmd = CreateCommandWithStoredProcedure("SP_GetTop5Courses", con, null);             // create the command
        try
        {
            SqlDataReader dataReader = cmd.ExecuteReader(CommandBehavior.CloseConnection);
            List<Object> Top5 = new List<Object>();
            ...
            while (dataReader.Read())
            {
                Top5.Add(new
                {
                    ...
                    RegisteredUsers= Convert.ToSingle(dataReader["num_registered_users"])
                });       
            }
            return Top5;
        }
